package com.algonics.encoder.video;
...
import com.algonics.encoder.BaseEncoder;
import com.algonics.encoder.Frame;
import com.algonics.encoder.input.video.FpsLimiter;
import com.algonics.encoder.input.video.GetCameraData;
import com.algonics.encoder.utils.CodecUtil;
import com.algonics.encoder.utils.yuv.YUVUtil;
...
public class VideoEncoder extends BaseEncoder implements GetCameraData {
  ...
  private void sendSPSandPPS(MediaFormat mediaFormat) {
    ...
    if (type.equals(CodecUtil.H265_MIME)) {
      ...
      Log.e("RtspServer","Server sendSPSandPPS: H264");
  ...
  public void formatChanged(@NonNull MediaCodec mediaCodec, @NonNull MediaFormat mediaFormat) {
    Log.e("RtspServer","Server formatChanged: mediaFormat "+mediaFormat);
