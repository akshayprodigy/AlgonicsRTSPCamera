...
import com.algonics.encoder.input.video.Camera1ApiManager;
...
import com.algonics.encoder.input.video.GetCameraData;
...
public abstract class Camera1Base
  ...
  public boolean prepareVideo(int width, int height, int fps, int bitrate, int iFrameInterval,
    ...
    Log.e("rtsp server","previewWidth: "+previewWidth+" width: "+width+" previewHeight: "+previewHeight+" height: "+height );
