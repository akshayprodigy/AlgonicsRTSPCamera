package com.algonics.rtplibrary.rtmp;
...
import com.algonics.rtmp.rtmp.RtmpClient;
import com.algonics.rtmp.utils.ConnectCheckerRtmp;
import com.algonics.rtplibrary.base.Camera2Base;
 ...
 * {@link com.algonics.rtplibrary.base.Camera2Base}
 *
...
public class RtmpCamera2 extends Camera2Base {
  ...
  @Override
  public CongetionDataOfAllClients hasCongestion() {
    //rtmpClient.hasCongestion();
    return new CongetionDataOfAllClients();
  }
