...
public interface GlInterface {
   ...
   * You can select any filter from {@link com.algonics.encoder.input.gl.render.filters} or create
   * your own filter if you extends from {@link com.algonics.encoder.input.gl.render.filters.BaseFilterRender}
   *
