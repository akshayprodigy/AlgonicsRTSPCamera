package com.algonics.rtplibrary.rtsp;
...
import com.algonics.rtsp.rtsp.Protocol;
...
public class RtspCamera2 extends Camera2Base {
  ...
  public CongetionDataOfAllClients hasCongestion() {
    ...
    CongetionDataOfAllClients vlient = new CongetionDataOfAllClients();
    vlient.congetionDataList.add(rtspClient.hasCongestion());
    return vlient;
