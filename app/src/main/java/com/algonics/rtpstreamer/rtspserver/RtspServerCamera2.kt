...
class RtspServerCamera2 : Camera2Base {
    ...
    override fun onSpsPpsVpsRtp(sps: ByteBuffer, pps: ByteBuffer, vps: ByteBuffer?) {
        ...
        //Log.i("RtspServerCamera2", "Server onSpsPpsVpsRtp newSps $newSps newPps: $newPps newVps: $newVps")
//        Log.d("RtspServerCamera2", "Server "+ Log.getStackTraceString(Exception()))
    ...
    override fun hasCongestion(): CongetionDataOfAllClients = rtspServer.hasCongestion()
